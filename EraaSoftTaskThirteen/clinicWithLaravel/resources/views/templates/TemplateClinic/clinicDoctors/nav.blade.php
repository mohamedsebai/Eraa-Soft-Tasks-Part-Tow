                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        <a type="button" class="btn btn-outline-light navigation--button" href="../index.php"
                            index.php">Home</a>
                        <a type="button" class="btn btn-outline-light navigation--button" href="../majors.php?page=1"
                            majors.php">majors</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./index.php?page=1">Doctors</a>

                            <a type="button" class="btn btn-outline-light navigation--button"
                             href="../doctor_profile/login.php">Doctor controle</a>
